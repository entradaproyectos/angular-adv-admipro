...
@Component({
  selector: 'app-cropimage600x258',
  templateUrl: './cropimage600x258.component.html',
  styleUrls: ['./cropimage600x258.component.css']
})
export class Cropimage600x258Component implements OnInit {
