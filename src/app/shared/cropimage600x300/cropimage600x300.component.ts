...
@Component({
  selector: 'app-cropimage600x300',
  templateUrl: './cropimage600x300.component.html',
  styleUrls: ['./cropimage600x300.component.css']
})
export class Cropimage600x300Component implements OnInit {
