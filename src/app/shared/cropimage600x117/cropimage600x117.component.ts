...
@Component({
  selector: 'app-cropimage600x117',
  templateUrl: './cropimage600x117.component.html',
  styleUrls: ['./cropimage600x117.component.css']
})
export class Cropimage600x117Component implements OnInit {
