...
@Component({
  selector: 'app-cropimage270x154',
  templateUrl: './cropimage270x154.component.html',
  styleUrls: ['./cropimage270x154.component.css']
})
export class Cropimage270x154Component implements OnInit {
