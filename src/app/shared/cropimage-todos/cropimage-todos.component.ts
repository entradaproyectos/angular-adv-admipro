...
@Component({
  selector: 'app-cropimage-todos',
  templateUrl: './cropimage-todos.component.html',
  styleUrls: ['./cropimage-todos.component.css']
})
export class CropimageTodosComponent implements OnInit {
